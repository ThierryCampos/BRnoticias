				...
				<div class="container">
					...
					<div id="menu-list">
						<ul class="nav-list">
							...
							<li><a href="category.html">Padrão</a></li>
							<li class="dropdown magz-dropdown">
								<a href="category.html">Páginas <i class="ion-ios-arrow-right"></i></a>
								<ul class="dropdown-menu">
									<li><a href="index.php">Home</a></li>
									<li class="dropdown magz-dropdown">
										<a href="#">Varzea Pta <i class="ion-ios-arrow-right"></i></a>
										<ul class="dropdown-menu">
											<li><a href="varzea.html">História</a></li>
											<li><a href="camara.html">Câmara</a></li>
										</ul>
									</li>
									<li><a href="politica.php">Política</a></li>
									<li><a href="saude.php">Saúde</a></li>
									<li><a href="brasil.php">Brasil e Mundo</a></li>
									<li><a href="esporte.php">Esporte</a></li>
									<li><a herf="contato.php">Contato</a></li>
									<li class="dropdown magz-dropdown">
										<a href="contract.html">Cultura e Entretenimento<i class="ion-ios-arrow-right"></i></a>
										<ul class="dropdown-menu">
							...
							<li class="dropdown magz-dropdown magz-dropdown-megamenu"><a href="#">Colunas <i class="ion-ios-arrow-right"></i></a>
								<div class="dropdown-menu megamenu">
									<div class="megamenu-inner">
										<div class="row">
											<div class="col-md-3">
												<h2 class="megamenu-title">Coluna 1</h2>
												<ul class="vertical-menu">
											...
											<div class="col-md-3">
												<h2 class="megamenu-title">Coluna 2</h2>
												<ul class="vertical-menu">
											...
											<div class="col-md-3">
												<h2 class="megamenu-title">Coluna 3</h2>
												<ul class="vertical-menu">
											...
											<div class="col-md-3">
												<h2 class="megamenu-title">Coluna 4</h2>
												<ul class="vertical-menu">
